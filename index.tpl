...
<!--Kaazing-->
<script src="<!--{$smarty.const.ROOT_URLPATH}-->js/eccube/client/WebSocket.js"></script>
<script src="<!--{$smarty.const.ROOT_URLPATH}-->js/eccube/client/JmsClient.js"></script>
<script src="<!--{$smarty.const.ROOT_URLPATH}-->js/eccube/kaazing.js"></script>
<!---->
...
.p_up_msg .close {
	...
	font-family:Arial, Helvetica, sans-serif, "Meiryo UI";
	line-height:normal;
	border-radius:2px;
...
<div class="p_up_box">
    <div class="p_up_msg">
        ...
        <span class="pop_message">pop up message</span>
    </div>
</div>
            ...
            <table summary="商品情報">
                ...
                <!--{foreach from=$cartItems[$key] item=item}-->
                    <tr style="<!--{if $item.error}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->">
                        ...
                        <td class="alignC product_stock_<!--{$item.productsClass.product_class_id|h}-->"><!--{$item.productsClass.stock|h}--></td>
